...
class DayFourSpec extends FlatSpec with Matchers {
  ...
  behavior of "Day Four"

  it should "report valid passphrases those who have no duplicate words" in {
    val input = Seq(
      "aa bb cc dd ee",
      "aa bb cc dd aa",
      "aa bb cc dd aaa"
    ...
    DayFour.numberOfValidPassphrases(input) shouldBe 2
  }

  it should "report valid passphrases those who do not contain anagrams" in {
    val input = Seq(
      "abcde fghij",
      "abcde xyz ecdab",
    ...
    DayFour.numberOfValidPassphrasesWithoutAnagrams(input) shouldBe 3
  }

  it should "report number of valid passphrases for the puzzle input" in {
    val input = Seq(
    ...
    DayFour.numberOfValidPassphrases(input) shouldBe 325
    DayFour.numberOfValidPassphrasesWithoutAnagrams(input) shouldBe 119
  }
}
